...
with tf.Session() as sess:
    ...
    num_batches = 0
    sample_count_int = 0
    o1 = open('/home/andrejs/data/qan/binary-autoencoder-master_binary2_10_ev1/model_training/train_loss.txt','a')
    o2 = open('/home/andrejs/data/qan/binary-autoencoder-master_binary2_10_ev1/model_training/dev_loss.txt','a')
